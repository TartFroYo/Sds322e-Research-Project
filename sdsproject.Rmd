...
```
The average rate of all reported offenses of Property-related Burglaries per 100,000 population is 731. The minimum and maximum rates are 201.7 per 100,000 and 1888.8 per 100,000. Considering the mean rate is low, this means that many of the rate are on the smaller side and that the there are few rates that have a value equal to the maximum.
# Visualizing
### 1 Variable Plots
...
rqs %>% filter(Year==2002) |>
  ...
  labs(title = "Distribution of Federal Funds to State Public Schools in 2002", 
       y = "Frequency") +
<<<<<<< HEAD
  scale_x_continuous(name = "U.S. Federal Funding to State Public Schools by Hundred Thousand Dollars in 2002") +
  # theme(axis.text.x = element_text(angle=90)) + 
=======
  scale_x_continuous(name = "U.S. Federal Funding to State Public Schools by Hundred Thousands in 2002") +
>>>>>>> 81ac65d438d32aca699bb28ba986606f93755fe8
  theme_bw()
...
Overall, the relationship between all murder rates and public school federal funding is slightly negative. There was not a general trend to be distinguished from the scatterplot (vis5). Although there is stronger inverse relationship seen in California, Texas, New York, and Floria. This pattern is likely more apparent due to these states have a larger population than the other states. Yet, there could be other confounding factors that are influencing this trend. We conclude that public school federal funding does not have a large effect on murder rates across states. 
### Is there a relationship between Median Household Income and Crimes?
Unlike the relationship between all murder rates and public school federal funding, the scatterplots (vis6) relationship between state median household income and burglary rates has a strong inverse relationship. A possible explanation for this could be due to the fact that having a higher household median income allows people to afford security appliances such as house cameras along with living in affluent neighborhoods where crime is relatively low. There could be other influences for this trend. Though, since every state has negative relationship, we conclude that there is a relationship between median household income and crimes.
