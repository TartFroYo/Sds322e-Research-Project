...
__Figure 1__ Figure 1 plots All_Violent_Rates
```{r vis1}
...
__Figure 2__ Figure 2 plots Fed_Rev.
```{r vis2}
...
__Figure 3__ Figure 3 plots Year and Federal_Revenue
```{r vis3}
...
__Figure 4__ Figure 4 plots Year and mi, which is a function of Median_Income.
```{r vis4}
...
__Figure 5__ Figure 5 plots All_Murder_Rates, Federal_Revenue, and State.
```{r vis5}
...
__Figure 6__ Figure 6 plots All_Property_Burglary_Rates, Median_Income, and State.
```{r vis6}
