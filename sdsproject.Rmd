...
Create a plot graphing three variables.
```{r vis5}
...
FM2 <- FM2[626:1250,]
```
We split the rsq dataset in half so that the data points on the scatterplots are more readily seen.
...
Create a second plot graphing three variables.
```{r vis7}
# find max murder rates
