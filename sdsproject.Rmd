...
crime_rate |> 
  ...
  labs(title = "U.S. State Distribution of All Violent Crime Rates in 2002 ", 
       y = "Frequency") + 
...
FM1 %>% 
  ggplot(aes(x = All_Murder_Rates, y = Federal_Revenue)) + 
  geom_point(aes(color = State), size =1/2) + 
...
# find max murder rates
summary(rqs$All_Property_Burglary_Rates)
>>>>>>> 7ac0b450b1bbe30bfb2862749b1eaa6da9ec4518
